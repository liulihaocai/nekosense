## Alpha branch
Alpha branch is based on MissedIT.
## Compiling
...
./Kali --update
```
## Injecting and Unloading using the load script
...
To add a config, create a folder inside of the `~/.config/Kali/` folder with a name of your choice, and paste the `config.json` inside of that folder.
