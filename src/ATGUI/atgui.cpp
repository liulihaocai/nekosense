...
void UI::SwapWindow()
{
	...
	Draw::ImText(ImVec2(4.f, 4.f), ImColor(255, 255, 255, 255), XORSTR("Kali.cc"), nullptr, 0.0f, nullptr,
	             ImFontFlags_Shadow);
}
...
bool UI::DrawImWatermark()
{
	...
	ImGui::Begin(XORSTR("##mainFrame"), (bool *) false,
	...
	{
		Draw::ImText(ImVec2(20.f, 10.f), ImColor(255, 255, 255, 255), XORSTR("Kali.cc | FPS :"), nullptr, 0.0f,
		             nullptr, ImFontFlags_Outline);
...
void UI::DrawMenuSelector()
{
	...
	ImGuiStyle &style = ImGui::GetStyle();
	style.WindowBorderSize = 0.0f;
	if (ImGui::Begin(XORSTR("##menuSlector"), (bool *) false,
	                 ImGuiWindowFlags_AlwaysUseWindowPadding | ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoMove |
	                 ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_NoResize)) {
...
void UI::angleIndicator()
{
	...
	ImGuiStyle &style = ImGui::GetStyle();
	style.WindowBorderSize = 0.0f;
	if (ImGui::Begin(XORSTR("##indecator"), (bool *) false,
	                 ImGuiWindowFlags_AlwaysUseWindowPadding | ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoMove |
	                 ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_NoResize)) {}
	{
		if (AntiAim::ManualAntiAim::alignBack) {
			Draw::ImText(ImVec2(20.f, 420.f), ImColor(54, 154, 255, 255), XORSTR("[ BACK ]"), nullptr, 0.0f, nullptr,
			             ImFontFlags_Shadow);
		} else if (AntiAim::ManualAntiAim::alignLeft) {
			Draw::ImText(ImVec2(20.f, 420.f), ImColor(54, 154, 255, 255), XORSTR("[ Left ]"), nullptr, 0.0f, nullptr,
			             ImFontFlags_Shadow);
		} else if (AntiAim::ManualAntiAim::alignRight) {
			Draw::ImText(ImVec2(20.f, 420.f), ImColor(54, 154, 255, 255), XORSTR("[ Right ]"), nullptr, 0.0f, nullptr,
			             ImFontFlags_Shadow);
		}
