...
ButtonCode_t Util::GetButtonCode(std::string buttonName) {
  for (int i = 0; i < ButtonCode_t::KEY_XSTICK2_UP; i++) {
    const char *currentButton =
        inputSystem->ButtonCodeToString((ButtonCode_t)i);
...
IMaterial *Util::CreateMaterial(std::string type, std::string texture,
                                bool ignorez, bool nofog, bool model,
                                bool nocull, bool halflambert) {
  static int matNum = 1;
  ...
  std::string time =
      randomLetter + std::string(__TIME__); // compile time XX:XX:XX
  time.erase(std::remove(time.begin(), time.end(), ':'),
             time.end()); // remove colons
...
IMaterial *Util::CreateMaterial(bool ignorez, std::string envmap,
                                std::string envmaptint, int envmapfresnel,
                                std::string envmapfresnelminmaxexp) {
  static int matNum = 1;
  std::stringstream materialData;
  materialData << "\""
                  "VertexLitGeneric"
...
IMaterial *Util::CreateMaterial(std::string type, std::string texture,
                                bool ignorez, bool nofog, bool model,
                                bool nocull, bool halflambert,
                                std::string envmap, std::string envmaptint,
                                int envmapfresnel,
                                std::string envmapfresnelminmaxexp) {
  static int matNum = 1;
  std::stringstream materialData;
...
IMaterial *Util::CreateMaterial2(std::string type, std::string texture,
                                 bool ignorez, bool nofog, bool model,
                                 bool nocull, float alpha) {
  static int matNum = 1;
  std::stringstream materialData;
  materialData << "\"" + type +
                      "\"\n"
...
IMaterial *Util::CreateMaterial4(std::string type, std::string texture,
                                 bool ignorez, bool nofog, bool model,
                                 bool nocull, float alpha, Vector color) {
  static int matNum = 1;
  std::stringstream materialData;
  materialData << "\"" + type +
                      "\"\n"
...
IMaterial *Util::CreateMaterial3(std::string type, std::string texture,
                                 bool ignorez, bool nofog, bool model,
                                 bool nocull, float alpha, Vector color) {
  static int matNum = 1;
  std::stringstream materialData;
...
IMaterial *Util::CreateMaterial3(std::string type, std::string texture,
  ...
  materialData << "\"" + type +
                      ...
                      "\"\n"
                      "\t\"$envmaptint\" \"" +
                      "[" + std::to_string(0) + " " + std::to_string(0.5) +
                      " " + std::to_string(0.55) + "]" +
                      "\"\n"
...
bool Util::IsDangerZone() { return (gameTypes->GetCurrentGameType() == 6); }
