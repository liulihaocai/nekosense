...
#define RageweaponSetting settings[XORSTR("Ragebot")][XORSTR("weapons")][Util::Items::GetItemName((enum ItemDefinitionIndex)i.first)]
		...
		RageweaponSetting[XORSTR("AutoCoutch")][XORSTR("enabled")] = i.second.AutoCrouch;
...
#undef RageweaponSetting
	...
	settings[XORSTR("Ragebot")][XORSTR("DamageOverrideBtn")] = Util::GetButtonName(
			Settings::Ragebot::DamageOverrideBtn);
	...
	settings[XORSTR("Triggerbot")][XORSTR("OnKey")][XORSTR("key")] = Util::GetButtonName(
			Settings::Triggerbot::OnKey::key);
	...
	settings[XORSTR("AntiAim")][XORSTR("EnableFakAngle")] = Settings::AntiAim::EnableFakAngle;
	...
	settings[XORSTR("AntiAim")][XORSTR("ManualAntiAim")][XORSTR("backButton")] = Util::GetButtonName(
			Settings::AntiAim::ManualAntiAim::backButton);
	settings[XORSTR("AntiAim")][XORSTR("ManualAntiAim")][XORSTR("rightButton")] = Util::GetButtonName(
			Settings::AntiAim::ManualAntiAim::RightButton);
	settings[XORSTR("AntiAim")][XORSTR("ManualAntiAim")][XORSTR("leftButton")] = Util::GetButtonName(
			Settings::AntiAim::ManualAntiAim::LeftButton);
	...
	// For Enemy
	settings[XORSTR("ESP")][XORSTR("Enemy")][XORSTR("Boxes")][XORSTR(
			"enabled")] = Settings::ESP::FilterEnemy::Boxes::enabled;
	settings[XORSTR("ESP")][XORSTR("Enemy")][XORSTR("Boxes")][XORSTR(
			"type")] = (int) Settings::ESP::FilterEnemy::Boxes::type;
	settings[XORSTR("ESP")][XORSTR("Enemy")][XORSTR("Skeleton")][XORSTR(
			"enabled")] = Settings::ESP::FilterEnemy::Skeleton::enabled;
	LoadColor(settings[XORSTR("ESP")][XORSTR("Enemy")][XORSTR("Skeleton")][XORSTR("ally_color")],
	          Settings::ESP::FilterEnemy::Skeleton::allyColor);
	LoadColor(settings[XORSTR("ESP")][XORSTR("Enemy")][XORSTR("Skeleton")][XORSTR("enemy_color")],
	          Settings::ESP::FilterEnemy::Skeleton::enemyColor);
	settings[XORSTR("ESP")][XORSTR("Enemy")][XORSTR("HelthBar")][XORSTR(
			"enabled")] = Settings::ESP::FilterEnemy::HelthBar::enabled;
	settings[XORSTR("ESP")][XORSTR("Enemy")][XORSTR("HelthBar")][XORSTR(
			"type")] = (int) Settings::ESP::FilterEnemy::HelthBar::type;
	settings[XORSTR("ESP")][XORSTR("Enemy")][XORSTR("Tracers")][XORSTR(
			"enabled")] = Settings::ESP::FilterEnemy::Tracers::enabled;
	settings[XORSTR("ESP")][XORSTR("Enemy")][XORSTR("Tracers")][XORSTR(
			"type")] = (int) Settings::ESP::FilterEnemy::Tracers::type;
	settings[XORSTR("ESP")][XORSTR("Enemy")][XORSTR("BulletTracers")][XORSTR(
			"enabled")] = Settings::ESP::FilterEnemy::BulletTracers::enabled;
	settings[XORSTR("ESP")][XORSTR("Enemy")][XORSTR("BulletBeam")][XORSTR(
			"enabled")] = Settings::ESP::FilterEnemy::BulletBeam::enabled;
	settings[XORSTR("ESP")][XORSTR("Enemy")][XORSTR("PlayerInfo")][XORSTR(
			"enabled")] = Settings::ESP::FilterEnemy::playerInfo::enabled;

	// For LocalPlayer
	settings[XORSTR("ESP")][XORSTR("Localplayer")][XORSTR("Boxes")][XORSTR(
			"enabled")] = Settings::ESP::FilterLocalPlayer::Boxes::enabled;
	settings[XORSTR("ESP")][XORSTR("Localplayer")][XORSTR("Boxes")][XORSTR(
			"type")] = (int) Settings::ESP::FilterLocalPlayer::Boxes::type;
	settings[XORSTR("ESP")][XORSTR("Localplayer")][XORSTR("Skeleton")][XORSTR(
			"enabled")] = Settings::ESP::FilterLocalPlayer::Skeleton::enabled;
	settings[XORSTR("ESP")][XORSTR("Localplayer")][XORSTR("FakeAngle")][XORSTR(
			"enabled")] = Settings::ESP::FilterLocalPlayer::RealChams::enabled;
	LoadColor(settings[XORSTR("ESP")][XORSTR("Localplayer")][XORSTR("Skeleton")][XORSTR("ally_color")],
	          Settings::ESP::FilterLocalPlayer::Skeleton::allyColor);
	LoadColor(settings[XORSTR("ESP")][XORSTR("Localplayer")][XORSTR("Skeleton")][XORSTR("enemy_color")],
	          Settings::ESP::FilterLocalPlayer::Skeleton::enemyColor);
	settings[XORSTR("ESP")][XORSTR("Localplayer")][XORSTR("Bars")][XORSTR(
			"enabled")] = Settings::ESP::FilterLocalPlayer::HelthBar::enabled;
	settings[XORSTR("ESP")][XORSTR("Localplayer")][XORSTR("Bars")][XORSTR(
			"color_type")] = (int) Settings::ESP::FilterLocalPlayer::HelthBar::colorType;
	settings[XORSTR("ESP")][XORSTR("Localplayer")][XORSTR("Bars")][XORSTR(
			"type")] = (int) Settings::ESP::FilterLocalPlayer::HelthBar::type;
	settings[XORSTR("ESP")][XORSTR("Localplayer")][XORSTR("Tracers")][XORSTR(
			"enabled")] = Settings::ESP::FilterLocalPlayer::Tracers::enabled;
	settings[XORSTR("ESP")][XORSTR("Localplayer")][XORSTR("Tracers")][XORSTR(
			"type")] = (int) Settings::ESP::FilterLocalPlayer::Tracers::type;
	settings[XORSTR("ESP")][XORSTR("Localplayer")][XORSTR("BulletTracers")][XORSTR(
			"enabled")] = Settings::ESP::FilterLocalPlayer::BulletTracers::enabled;
	settings[XORSTR("ESP")][XORSTR("Localplayer")][XORSTR("BulletBeam")][XORSTR(
			"enabled")] = Settings::ESP::FilterLocalPlayer::BulletBeam::enabled;
	settings[XORSTR("ESP")][XORSTR("Localplayer")][XORSTR("PlayerInfo")][XORSTR(
			"enabled")] = Settings::ESP::FilterLocalPlayer::playerInfo::enabled;

	// For Alise
	settings[XORSTR("ESP")][XORSTR("Alise")][XORSTR("Boxes")][XORSTR(
			"enabled")] = Settings::ESP::FilterAlice::Boxes::enabled;
	settings[XORSTR("ESP")][XORSTR("Alise")][XORSTR("Boxes")][XORSTR(
			"type")] = (int) Settings::ESP::FilterAlice::Boxes::type;
	settings[XORSTR("ESP")][XORSTR("Alise")][XORSTR("Skeleton")][XORSTR(
			"enabled")] = Settings::ESP::FilterAlice::Skeleton::enabled;
	LoadColor(settings[XORSTR("ESP")][XORSTR("Alise")][XORSTR("Skeleton")][XORSTR("ally_color")],
	          Settings::ESP::FilterAlice::Skeleton::allyColor);
	LoadColor(settings[XORSTR("ESP")][XORSTR("Alise")][XORSTR("Skeleton")][XORSTR("enemy_color")],
	          Settings::ESP::FilterAlice::Skeleton::enemyColor);
	settings[XORSTR("ESP")][XORSTR("Alise")][XORSTR("Bars")][XORSTR(
			"enabled")] = Settings::ESP::FilterAlice::HelthBar::enabled;
	settings[XORSTR("ESP")][XORSTR("Alise")][XORSTR("Bars")][XORSTR(
			"color_type")] = (int) Settings::ESP::FilterAlice::HelthBar::colorType;
	settings[XORSTR("ESP")][XORSTR("Alise")][XORSTR("Bars")][XORSTR(
			"type")] = (int) Settings::ESP::FilterAlice::HelthBar::type;
	settings[XORSTR("ESP")][XORSTR("Alise")][XORSTR("Tracers")][XORSTR(
			"enabled")] = Settings::ESP::FilterAlice::Tracers::enabled;
	settings[XORSTR("ESP")][XORSTR("Alise")][XORSTR("Tracers")][XORSTR(
			"type")] = (int) Settings::ESP::FilterAlice::Tracers::type;
	settings[XORSTR("ESP")][XORSTR("Alise")][XORSTR("BulletTracers")][XORSTR(
			"enabled")] = Settings::ESP::FilterAlice::BulletTracers::enabled;
	settings[XORSTR("ESP")][XORSTR("Alise")][XORSTR("BulletBeam")][XORSTR(
			"enabled")] = Settings::ESP::FilterAlice::BulletBeam::enabled;
	settings[XORSTR("ESP")][XORSTR("Alise")][XORSTR("PlayerInfo")][XORSTR(
			"enabled")] = Settings::ESP::FilterAlice::playerInfo::enabled;

	//Various Settings for Helth vae
	// For Enemy
	settings[XORSTR("ESP")][XORSTR("Enemy")][XORSTR("Bars")][XORSTR(
			"enabled")] = &Settings::ESP::FilterEnemy::HelthBar::enabled;
	settings[XORSTR("ESP")][XORSTR("Enemy")][XORSTR("Bars")][XORSTR(
			"type")] = (int *) &Settings::ESP::FilterEnemy::HelthBar::type;
	// END
	...
	// For Enemy
	settings[XORSTR("ESP")][XORSTR("Chams")][XORSTR("Enemy")][XORSTR(
			"enabled")] = Settings::ESP::FilterEnemy::Chams::enabled;
	settings[XORSTR("ESP")][XORSTR("Chams")][XORSTR("Enemy")][XORSTR(
			"type")] = (int) Settings::ESP::FilterEnemy::Chams::type;
	// For Local Player
	settings[XORSTR("ESP")][XORSTR("Chams")][XORSTR("Localplayer")][XORSTR(
			"enabled")] = Settings::ESP::FilterLocalPlayer::Chams::enabled;
	settings[XORSTR("ESP")][XORSTR("Chams")][XORSTR("Localplayer")][XORSTR(
			"Fake")] = (int) Settings::ESP::FilterLocalPlayer::Chams::type;
	settings[XORSTR("ESP")][XORSTR("Chams")][XORSTR("Localplayer")][XORSTR(
			"Real")] = (int) Settings::ESP::FilterLocalPlayer::RealChams::type;
	// For Alise
	settings[XORSTR("ESP")][XORSTR("Chams")][XORSTR("Alise")][XORSTR(
			"enabled")] = Settings::ESP::FilterAlice::Chams::enabled;
	settings[XORSTR("ESP")][XORSTR("Chams")][XORSTR("Alise")][XORSTR(
			"type")] = (int) Settings::ESP::FilterAlice::Chams::type;
	...
	settings[XORSTR("SkinChanger")][XORSTR("Models")][XORSTR(
			"playerModel")] = (int) Settings::Skinchanger::Models::playerModel;
...
#undef skinSetting
	...
	settings[XORSTR("ThirdPerson")][XORSTR("togglekey")] = Util::GetButtonName(
			Settings::ThirdPerson::toggleThirdPerson);
...
void Settings::LoadConfig(std::string path)
{
	...
	for (Json::ValueIterator itr = settings[XORSTR("Legitbot")][XORSTR("weapons")].begin();
	     itr != settings[XORSTR("Legitbot")][XORSTR("weapons")].end(); itr++) {
		...
		LegitWeapon_t weapon = {
				...
				.smoothSaltEnabled = LegitweaponSetting[XORSTR("Smooth")][XORSTR("Salting")][XORSTR(
						"Enabled")].asBool(),
				...
				.smoothSaltMultiplier = LegitweaponSetting[XORSTR("Smooth")][XORSTR("Salting")][XORSTR(
						"Multiplier")].asFloat(),
	...
	for (Json::ValueIterator itr = settings[XORSTR("Ragebot")][XORSTR("weapons")].begin();
	     itr != settings[XORSTR("Ragebot")][XORSTR("weapons")].end(); itr++) {
		...
		RageWeapon_t weapon = {
				...
				.AutoCrouch = RageweaponSetting[XORSTR("AutoCoutch")][XORSTR("enabled")].asBool(),
		...
		for (int bone = 0; bone < 6; bone++) {
			...
			weapon.desiredMultiBones[bone] = RageweaponSetting[XORSTR("DesireMultiBones")][XORSTR(
					"Bones")][bone].asBool();
		}
	...
	GetVal(settings[XORSTR("LagComp")][XORSTR("enable")], &Settings::LagComp::enabled);
	...
	GetVal(settings[XORSTR("AntiAim")][XORSTR("EnableFakAngle")], &Settings::AntiAim::EnableFakAngle);
	...
	GetVal(settings[XORSTR("AntiAim")][XORSTR("Jitter")][XORSTR("SyncWithLag")],
	       &Settings::AntiAim::Jitter::SyncWithLag);

	// Settings loading Manual AntiAIm
	GetVal(settings[XORSTR("AntiAim")][XORSTR("ManualAntiAim")][XORSTR("Enable")],
	       &Settings::AntiAim::ManualAntiAim::Enable);
	GetButtonCode(settings[XORSTR("AntiAim")][XORSTR("ManualAntiAim")][XORSTR("backButton")],
	              &Settings::AntiAim::ManualAntiAim::backButton);
	GetButtonCode(settings[XORSTR("AntiAim")][XORSTR("ManualAntiAim")][XORSTR("rightButton")],
	              &Settings::AntiAim::ManualAntiAim::RightButton);
	GetButtonCode(settings[XORSTR("AntiAim")][XORSTR("ManualAntiAim")][XORSTR("leftButton")],
	              &Settings::AntiAim::ManualAntiAim::LeftButton);
	...
	// Visual Settings for various players
	// For Enemy
	GetVal(settings[XORSTR("ESP")][XORSTR("Enemy")][XORSTR("Boxes")][XORSTR("enabled")],
	       &Settings::ESP::FilterEnemy::Boxes::enabled);
	GetVal(settings[XORSTR("ESP")][XORSTR("Enemy")][XORSTR("Boxes")][XORSTR("type")],
	       (int *) &Settings::ESP::FilterEnemy::Boxes::type);
	GetVal(settings[XORSTR("ESP")][XORSTR("Enemy")][XORSTR("Skeleton")][XORSTR("enabled")],
	       &Settings::ESP::FilterEnemy::Skeleton::enabled);
	GetVal(settings[XORSTR("ESP")][XORSTR("Enemy")][XORSTR("Skeleton")][XORSTR("ally_color")],
	       &Settings::ESP::FilterEnemy::Skeleton::allyColor);
	GetVal(settings[XORSTR("ESP")][XORSTR("Enemy")][XORSTR("Skeleton")][XORSTR("enemy_color")],
	       &Settings::ESP::FilterEnemy::Skeleton::enemyColor);
	GetVal(settings[XORSTR("ESP")][XORSTR("Enemy")][XORSTR("HelthBar")][XORSTR("enabled")],
	       &Settings::ESP::FilterEnemy::HelthBar::enabled);
	GetVal(settings[XORSTR("ESP")][XORSTR("Enemy")][XORSTR("HelthBar")][XORSTR("type")],
	       (int *) &Settings::ESP::FilterEnemy::HelthBar::type);
	GetVal(settings[XORSTR("ESP")][XORSTR("Enemy")][XORSTR("Tracers")][XORSTR("enabled")],
	       &Settings::ESP::FilterEnemy::Tracers::enabled);
	GetVal(settings[XORSTR("ESP")][XORSTR("Enemy")][XORSTR("Tracers")][XORSTR("type")],
	       (int *) &Settings::ESP::FilterEnemy::Tracers::type);
	GetVal(settings[XORSTR("ESP")][XORSTR("Enemy")][XORSTR("BulletTracers")][XORSTR("enabled")],
	       &Settings::ESP::FilterEnemy::BulletTracers::enabled);
	GetVal(settings[XORSTR("ESP")][XORSTR("Enemy")][XORSTR("BulletBeam")][XORSTR("enabled")],
	       &Settings::ESP::FilterEnemy::BulletBeam::enabled);
	GetVal(settings[XORSTR("ESP")][XORSTR("Enemy")][XORSTR("PlayerInfo")][XORSTR("enabled")],
	       &Settings::ESP::FilterEnemy::playerInfo::enabled);
	// For LocalPlayer
	GetVal(settings[XORSTR("ESP")][XORSTR("Localplayer")][XORSTR("Boxes")][XORSTR("enabled")],
	       &Settings::ESP::FilterLocalPlayer::Boxes::enabled);
	GetVal(settings[XORSTR("ESP")][XORSTR("Localplayer")][XORSTR("Boxes")][XORSTR("type")],
	       (int *) &Settings::ESP::FilterLocalPlayer::Boxes::type);
	GetVal(settings[XORSTR("ESP")][XORSTR("Localplayer")][XORSTR("Skeleton")][XORSTR("enabled")],
	       &Settings::ESP::FilterLocalPlayer::Skeleton::enabled);
	GetVal(settings[XORSTR("ESP")][XORSTR("Localplayer")][XORSTR("FakeAngle")][XORSTR("enabled")],
	       &Settings::ESP::FilterLocalPlayer::RealChams::enabled);
	GetVal(settings[XORSTR("ESP")][XORSTR("Localplayer")][XORSTR("Skeleton")][XORSTR("ally_color")],
	       &Settings::ESP::FilterLocalPlayer::Skeleton::allyColor);
	GetVal(settings[XORSTR("ESP")][XORSTR("Localplayer")][XORSTR("Skeleton")][XORSTR("enemy_color")],
	       &Settings::ESP::FilterLocalPlayer::Skeleton::enemyColor);
	GetVal(settings[XORSTR("ESP")][XORSTR("Localplayer")][XORSTR("HelthBar")][XORSTR("enabled")],
	       &Settings::ESP::FilterLocalPlayer::HelthBar::enabled);
	GetVal(settings[XORSTR("ESP")][XORSTR("Localplayer")][XORSTR("HelthBar")][XORSTR("type")],
	       (int *) &Settings::ESP::FilterLocalPlayer::HelthBar::type);
	GetVal(settings[XORSTR("ESP")][XORSTR("Localplayer")][XORSTR("Tracers")][XORSTR("enabled")],
	       &Settings::ESP::FilterLocalPlayer::Tracers::enabled);
	GetVal(settings[XORSTR("ESP")][XORSTR("Localplayer")][XORSTR("Tracers")][XORSTR("type")],
	       (int *) &Settings::ESP::FilterLocalPlayer::Tracers::type);
	GetVal(settings[XORSTR("ESP")][XORSTR("Localplayer")][XORSTR("BulletTracers")][XORSTR("enabled")],
	       &Settings::ESP::FilterLocalPlayer::BulletTracers::enabled);
	GetVal(settings[XORSTR("ESP")][XORSTR("Localplayer")][XORSTR("BulletBeam")][XORSTR("enabled")],
	       &Settings::ESP::FilterLocalPlayer::BulletBeam::enabled);
	GetVal(settings[XORSTR("ESP")][XORSTR("Localplayer")][XORSTR("PlayerInfo")][XORSTR("enabled")],
	       &Settings::ESP::FilterLocalPlayer::playerInfo::enabled);
	//For Alise
	GetVal(settings[XORSTR("ESP")][XORSTR("Alise")][XORSTR("Boxes")][XORSTR("enabled")],
	       &Settings::ESP::FilterAlice::Boxes::enabled);
	GetVal(settings[XORSTR("ESP")][XORSTR("Alise")][XORSTR("Boxes")][XORSTR("type")],
	       (int *) &Settings::ESP::FilterAlice::Boxes::type);
	GetVal(settings[XORSTR("ESP")][XORSTR("Alise")][XORSTR("Skeleton")][XORSTR("enabled")],
	       &Settings::ESP::FilterAlice::Skeleton::enabled);
	GetVal(settings[XORSTR("ESP")][XORSTR("Alise")][XORSTR("Skeleton")][XORSTR("ally_color")],
	       &Settings::ESP::FilterAlice::Skeleton::allyColor);
	GetVal(settings[XORSTR("ESP")][XORSTR("Alise")][XORSTR("Skeleton")][XORSTR("enemy_color")],
	       &Settings::ESP::FilterAlice::Skeleton::enemyColor);
	GetVal(settings[XORSTR("ESP")][XORSTR("Alise")][XORSTR("HelthBar")][XORSTR("enabled")],
	       &Settings::ESP::FilterAlice::HelthBar::enabled);
	GetVal(settings[XORSTR("ESP")][XORSTR("Alise")][XORSTR("HelthBar")][XORSTR("type")],
	       (int *) &Settings::ESP::FilterAlice::HelthBar::type);
	GetVal(settings[XORSTR("ESP")][XORSTR("Alise")][XORSTR("Tracers")][XORSTR("enabled")],
	       &Settings::ESP::FilterAlice::Tracers::enabled);
	GetVal(settings[XORSTR("ESP")][XORSTR("Alise")][XORSTR("Tracers")][XORSTR("type")],
	       (int *) &Settings::ESP::FilterAlice::Tracers::type);
	GetVal(settings[XORSTR("ESP")][XORSTR("Alise")][XORSTR("BulletTracers")][XORSTR("enabled")],
	       &Settings::ESP::FilterAlice::BulletTracers::enabled);
	GetVal(settings[XORSTR("ESP")][XORSTR("Alise")][XORSTR("BulletBeam")][XORSTR("enabled")],
	       &Settings::ESP::FilterAlice::BulletBeam::enabled);
	GetVal(settings[XORSTR("ESP")][XORSTR("Alise")][XORSTR("PlayerInfo")][XORSTR("enabled")],
	       &Settings::ESP::FilterAlice::playerInfo::enabled);
	// END
	...
	// For Enemy
	GetVal(settings[XORSTR("ESP")][XORSTR("Chams")][XORSTR("Enemy")][XORSTR("enabled")],
	       &Settings::ESP::FilterEnemy::Chams::enabled);
	GetVal(settings[XORSTR("ESP")][XORSTR("Chams")][XORSTR("Enemy")][XORSTR("type")],
	       (int *) &Settings::ESP::FilterEnemy::Chams::type);
	// For Local Player
	GetVal(settings[XORSTR("ESP")][XORSTR("Chams")][XORSTR("Localplayer")][XORSTR("enabled")],
	       &Settings::ESP::FilterLocalPlayer::Chams::enabled);
	GetVal(settings[XORSTR("ESP")][XORSTR("Chams")][XORSTR("Localplayer")][XORSTR("Fake")],
	       (int *) &Settings::ESP::FilterLocalPlayer::Chams::type);
	GetVal(settings[XORSTR("ESP")][XORSTR("Chams")][XORSTR("Localplayer")][XORSTR("Real")],
	       (int *) &Settings::ESP::FilterLocalPlayer::RealChams::type);
	// For Alise
	GetVal(settings[XORSTR("ESP")][XORSTR("Chams")][XORSTR("Alise")][XORSTR("enabled")],
	       &Settings::ESP::FilterAlice::Chams::enabled);
	GetVal(settings[XORSTR("ESP")][XORSTR("Chams")][XORSTR("Alise")][XORSTR("type")],
	       (int *) &Settings::ESP::FilterAlice::Chams::type);
	// END Visual Settings
	...
	GetVal(settings[XORSTR("SkinChanger")][XORSTR("Models")][XORSTR("playerModel")],
	       (int *) &Settings::Skinchanger::Models::playerModel);
